...
(function () {
  ...
  var schedule = {
    ...
    slots: [
      ...
      { start: "13:15", end: "13:30", phase: "grupe", group: "A", players: ["antonio-rajkovic", "ian-miocic"], score: [0, 4] },
      ...
      { start: "14:00", end: "14:15", phase: "grupe", group: "B", players: ["ivan-martinac", "marko-martinovic"], score: [3, 4], tiebreak: [4, 6] },
      { start: "14:15", end: "14:30", phase: "grupe", group: "D", players: ["mario-soco", "zeljko-bilic"], score: [4, 0] },
      ...
      { start: "15:30", end: "15:45", phase: "grupe", group: "C", players: ["antonio-jonjic", "jurica-separovic"], score: [2, 4] },
      { start: "15:45", end: "16:00", phase: "grupe", group: "A", players: ["franko-miocic", "vanja-lopusinsky"], score: [4, 0] },
      { start: "16:00", end: "16:20", phase: "zavrsnica", stage: "1/4", bracket: "glavni", format: "6", sides: [{ player: "mario-soco", score: 6 }, { player: "marko-dragunic", score: 4 }] },
      { start: "16:20", end: "16:40", phase: "zavrsnica", stage: "1/4", bracket: "glavni", format: "6", sides: [{ player: "jurica-separovic", score: 6 }, { player: "ian-miocic", score: 3 }] },
      { start: "16:40", end: "17:00", phase: "zavrsnica", stage: "1/4", bracket: "glavni", format: "6", sides: [{ player: "franko-miocic", score: 6 }, { player: "zeljko-bilic", score: 5 }] },
      { start: "17:00", end: "17:20", phase: "zavrsnica", stage: "1/4", bracket: "glavni", format: "6", sides: [{ player: "antonio-jonjic", score: 6 }, { player: "borna-katavic", score: 4 }] },
      ...
      { start: "17:40", end: "18:00", phase: "zavrsnica", stage: "1/2", bracket: "utjesni", format: "6", sides: [{ player: "vanja-lopusinsky", score: 6 }, { player: "mateo-gugic", score: 1 }] },
      ...
      { start: "19:00", end: "19:30", phase: "zavrsnica", stage: "F", bracket: "utjesni", format: "2x4", sides: [{ player: "ivan-tomic", score: 1 }, { player: "vanja-lopusinsky", score: 2 }], setScores: [[4, 3], [1, 4]], matchTiebreak: [3, 7] },
      { start: "19:30", end: "20:00", phase: "zavrsnica", stage: "F", bracket: "glavni", format: "2x4", sides: [{ player: "mario-soco", score: 2 }, { player: "antonio-jonjic", score: 0 }], setScores: [[4, 1], [4, 2]] }
    ]
  };
