...
(function () {
  ...
  var schedule = {
    ...
    slots: [
      { start: "10:00", end: "10:15", phase: "grupe", group: "A", players: ["antonio-rajkovic", "vanja-lopusinsky"] },
      { start: "10:15", end: "10:30", phase: "grupe", group: "B", players: ["marko-dragunic", "borna-katavic"] },
      { start: "10:30", end: "10:45", phase: "grupe", group: "D", players: ["filip-ivis", "zeljko-bilic"] },
      { start: "10:45", end: "11:00", phase: "grupe", group: "B", players: ["marko-dragunic", "ivan-martinac"] },
      { start: "11:00", end: "11:15", phase: "grupe", group: "D", players: ["filip-ivis", "ivan-tomic"] },
      { start: "11:15", end: "11:30", phase: "grupe", group: "B", players: ["marko-dragunic", "marko-martinovic"] },
      ...
      { start: "12:00", end: "12:15", phase: "grupe", group: "D", players: ["zeljko-bilic", "ivan-tomic"] },
      { start: "12:15", end: "12:30", phase: "grupe", group: "A", players: ["ian-miocic", "vanja-lopusinsky"] },
      { start: "12:30", end: "12:45", phase: "grupe", group: "C", players: ["mateo-gugic", "borna-mesin"] },
      { start: "12:45", end: "13:00", phase: "grupe", group: "B", players: ["ivan-martinac", "borna-katavic"] },
